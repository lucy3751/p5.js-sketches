...
function keyPressed(){
    ...
    if(keyCode === 83){
        ...
        saveCanvas("c-day"+day,"png")//(name, file extension)
...
function drawC(){
    ...
    beginShape();
        ...
        //diagonal line extending from second row 4th circle to bottom row 3rd circle, going clockwise
        ...
        //bottom row 3rd circle to second last row 4th circle
        vertex(circlesSecondLastRow[3].centerX - circlesSecondTopRow[3].radius, circlesSecondLastRow[3].centerY);
       

        //vertical line extending from second last row last circle to last row last circle
        ...
        //bottom row last circle to second circle
        ...
        //first row second last circle
        vertex(circlesTopRow[3].centerX, circlesTopRow[3].centerY- circlesTopRow[3].radius);
        
        //first row last circle extending to second row last cricle
        vertex(circlesTopRow[4].centerX, circlesTopRow[4].centerY - circlesTopRow[4].radius);
        vertex(circlesSecondTopRow[4].centerX + circlesSecondTopRow[4].radius, circlesSecondTopRow[4].centerY);
